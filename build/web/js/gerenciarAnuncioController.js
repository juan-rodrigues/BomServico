function MostraAnuncios(apagou=false)
{
    if(!apagou)
    ...
    const URL_TO_FETCH='TelaGerenciarAnuncio?acao=consultar&filtro='+filtro;
...
function ApagaAnuncio(acao, cod)
{   //event.preventDefault(); // evita refresh da tela
    var url = "TelaGerenciarAnuncio?acao=apagar&cod=" + cod;
